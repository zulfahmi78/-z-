        ...
        if op.type == 26:
         ...
         if op.type == 19:
           if op.param2 not in admin:
                ...
                satpam1.acceptGroupInvitationByTicket(op.param1,Ticket)
                time.sleep(0.2)
                ...
                if targets ==[]:
                    ...
                    for target in targets:
                        try:
                            satpam1.kickoutFromGroup(op.param1,[target])
                            satpam2.kickoutFromGroup(op.param1,[target])
